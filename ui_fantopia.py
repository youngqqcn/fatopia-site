...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.btnOpenOrdersFile.setGeometry(QRect(730, 7, 71, 27))
        ...
        self.label.setGeometry(QRect(75, 12, 141, 17))
        self.label_2 = QLabel(Widget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(51, 45, 161, 20))
        self.leAreaSeatsFilePath = QLineEdit(Widget)
        self.leAreaSeatsFilePath.setObjectName(u"leAreaSeatsFilePath")
        self.leAreaSeatsFilePath.setGeometry(QRect(220, 43, 501, 25))
        ...
        self.btnOpenAreaSeatsFile.setGeometry(QRect(730, 42, 71, 28))
        self.btnStartArrangeSeats = QPushButton(Widget)
        self.btnStartArrangeSeats.setObjectName(u"btnStartArrangeSeats")
        self.btnStartArrangeSeats.setGeometry(QRect(870, 70, 251, 101))
        self.teLog = LogTextEdit(Widget)
        self.teLog.setObjectName(u"teLog")
        self.teLog.setGeometry(QRect(30, 190, 1091, 551))
        self.label_3 = QLabel(Widget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(110, 80, 101, 20))
        self.leAreaSorts = QLineEdit(Widget)
        self.leAreaSorts.setObjectName(u"leAreaSorts")
        self.leAreaSorts.setGeometry(QRect(220, 80, 501, 25))
        self.leSpecialAreaRowSorts = QLineEdit(Widget)
        self.leSpecialAreaRowSorts.setObjectName(u"leSpecialAreaRowSorts")
        self.leSpecialAreaRowSorts.setGeometry(QRect(220, 118, 501, 25))
        self.label_4 = QLabel(Widget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(85, 120, 121, 17))
        self.label_5 = QLabel(Widget)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(56, 150, 161, 30))
        self.spinBoxOrderGroupGasSeconds = QSpinBox(Widget)
        self.spinBoxOrderGroupGasSeconds.setObjectName(u"spinBoxOrderGroupGasSeconds")
        self.spinBoxOrderGroupGasSeconds.setGeometry(QRect(220, 152, 81, 30))
        self.spinBoxOrderGroupGasSeconds.setMinimum(1)
    ...
    def retranslateUi(self, Widget):
        ...
        self.label_5.setText(QCoreApplication.translate("Widget", u"\u8ba2\u5355\u5206\u7ec4\u95f4\u9694\u65f6\u95f4(\u79d2):", None))
        self.spinBoxOrderGroupGasSeconds.setSuffix("")
    # retranslateUi
